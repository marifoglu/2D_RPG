...
public class UI : MonoBehaviour
{
    ...
    public void SetupControlUI(PlayerInputSet inputSet)
    {
        ...
        // ESCAPE KEY - Close all UIs or open Options
        input.UI.OptionsUI.performed += ctx => HandleEscapeKey();
    }
    ...
    private void HandleEscapeKey()
    {
        ...
        if (anyUIOpen)
        {
            // CLOSE ALL UIs and return to game
            CloseAllUIs();
        }
        else
        {
            // NO UI is open, so OPEN Options
            OpenOptionsUI();
        }
    }
