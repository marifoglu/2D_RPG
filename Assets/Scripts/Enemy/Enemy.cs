...
//    [Tooltip("Enemy rarity determines experience and loot quality")]
...
public class Enemy : Entity
{
    ...
    /// <summary>
    /// Flips the enemy to face the target if they're behind
    /// </summary>
    ...
    /// <summary>
    /// Checks if the player is behind the enemy (not in front raycast detection)
    /// </summary>
