...
public class Object_Portal : MonoBehaviour, ISaveable
{
    ...
    [SerializeField] private Vector2 defaultPosition; // portal appearance position
    [SerializeField] private string townSceneName = "Demo_Level_0";
    ...
    private void Awake()
    {
        ...
        transform.position = new Vector3(9999,9999); // hide portal off-screen initially
    }

    public void ActivatePortal(Vector3 position, int faceDir = 1)
    {
        isActive = true;
        transform.position = position;
        SaveManager.instance.GetGameData().inScenePortals.Clear(); // clear other portals in the scene
    ...
    public void DisableIfNeeded()
    {
        ...
        isActive = false;
        transform.position = new Vector3(9999, 9999); // hide portal off-screen
    }
